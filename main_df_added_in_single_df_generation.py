...
# json_path = "s3://datawarehouse-bilight/LentraData/LOS3.0/insuranceData/Daily/2024/10/07/insuranceData_20241007000000.json"
...
# schema_df.to_csv("s3://datawarehouse-bilight/Staging/LOS3.0/dmDetails/Yearly/testing/schema_info.csv", index=False)
...
# json_file_path_2 = "s3://datawarehouse-bilight/LentraData/LOS3.0/insuranceData/Daily/2024/10/07/insuranceData_20241007000000.json"
...
#     # Use PySpark's write.csv() to store CSV in the S3 bucket
#     s3_output_path = f's3://{s3_bucket}/{s3_prefix}/{df_name}.csv'
#     code_str += f'df_{df_name}.toPandas().to_csv("{s3_output_path}")'
#     return code_str
...
# main_df.printSchema()
# main_df.toPandas().to_csv(f"s3://{s3_bucket}/{s3_prefix}/main_df.csv")
# """
...
#     s3_key_main = f"{s3_prefix}/main.py"
...
# schema_file_path = "s3://datawarehouse-bilight/Staging/LOS3.0/dmDetails/Yearly/testing/schema_info.csv"
# s3_bucket = 'datawarehouse-bilight'  # Replace with your S3 bucket name
# s3_prefix = 'Staging/LOS3.0/dmDetails/Yearly/testing'  # Replace with the desired S3 prefix (folder path)
...
script_prefix = 'Staging/LOS3.0/dmDetails/Yearly/testing/'  # Directory containing the Python scripts in S3
